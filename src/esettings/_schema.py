__all__ = ["PlainSchemaType", "Schema", "SchemaType", "validate_schema"]
...
PlainSchemaType: TypeAlias = None | int | float | str | bool
SchemaType: TypeAlias = "PlainSchemaType | list[PlainSchemaType]"
...
_VALID_TYPES: Final = {None, NoneType, int, float, str, bool}
